 ...
 * Se crea una clase hija(EstudianteTipoA) basandose en una clase padre(Estudiante), por lo que se puede evidenciar el
 * uso de herencia.
 * */
public class EstudianteTipoA extends Estudiante {
     ...
     * @param NotaP3
     */
    public EstudianteTipoA(int carnet, String Nombre_Apellidos, String Correo , int telefono,String Nickname,String TipoEstudiante,
